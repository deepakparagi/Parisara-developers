...
export const defaultMessages = {
    general: "Hi, I'm interested in Parisara Layout plots. Can you provide more details?",
    siteVisit: "Hello, I would like to book a site visit for Parisara Layout.",
